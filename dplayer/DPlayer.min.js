...
}(window, (function()
{
    ...
    }, function(e, t, a)
    {
        ...
        {
            (t = t ||
            {}).singleton || "boolean" == typeof t.singleton || (t.singleton = o());
            var a = s(e = e || [], t);
            return function(e)
            {
        ...
        (function(e, t)
        {
            ! function(e, a)
            {
                ...
                if (!e.setImmediate)
                {
                    ...
                    u = u && u.setTimeout ? u : e, "[object process]" ===
                    {}.toString.call(e.process) ? n = function(e)
                    {
                        t.nextTick((function()
                        {
                            h(e)
    ...
    }, function(e, t, a)
    {
        ...
        e.exports = function(e)
        {
            return l(e), e.headers = e.headers ||
            {}, e.data = o(e.data, e.headers, e.transformRequest), e.headers = n.merge(e.headers.common ||
            {}, e.headers[e.method] ||
